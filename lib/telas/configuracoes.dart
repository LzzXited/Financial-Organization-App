            ...
            _Secao('Como o saldo é calculado', const [
              Padding(
                ...
                child: Text(
                  ...
                  '• A pagar = contas a pagar + assinaturas ainda não pagas no mês.\n'
                  '• Saldo geral = Livre + Investido + Na rua − A pagar.\n\n'
                  'As assinaturas já descontam do saldo antes de você pagar. Quando você paga, '
                  'o valor sai do Livre e a assinatura fica em dia. No mês seguinte ela volta '
                  'a ficar em aberto e desconta de novo.\n\n'
